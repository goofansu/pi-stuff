...
- [`btw.ts`](extensions/btw.ts) - Ask a question with full session context using the current model. No tools — answers from what's already in context. Result shown in a dismissible overlay; main branch is unchanged.
