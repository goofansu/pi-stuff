...
- [`review.ts`](extensions/review.ts) - Code review command inspired by Codex. Supports reviewing uncommitted changes, against a base branch (PR style), specific commits, or with custom instructions. Includes Ctrl+R shortcut. ([source](https://github.com/mitsuhiko/agent-stuff/blob/main/pi-extensions/review.ts))
